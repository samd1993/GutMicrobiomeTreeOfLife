...
#use python to filter GMTOL_jian_taxonomy.tsv to match feature IDs in GMTOLsong_table2024_N20_f2all_V4_Vert.biom by importing biom file and getting table from it and then using pandas to match up the two tables

#use biom to get the feature IDs from the biom file
