...
#export GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam.qza
qiime tools export \
  --input-path GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam.qza \
  --output-path ~/TOL/phylo/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam
#and then convert to tsv
biom convert \
  -i ~/TOL/phylo/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam/feature-table.biom \
  -o ~/TOL/phylo/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam.tsv \
  --to-tsv

  #copy to /ddn_scratch/sdegregori/cancer_mam
cp ~/TOL/phylo/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam.tsv /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam.tsv

#filter the qza table to only include reads with more than 100 reads
qiime feature-table filter-features \
  --i-table /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam.qza \
  --p-min-frequency 100 \
  --o-filtered-table /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100.qza

  #and then samples with less than 200k reads
qiime feature-table filter-samples \
  --i-table /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100.qza \
  --p-min-frequency 100 \
  --p-max-frequency 200000 \
  --o-filtered-table /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100_200k.qza

#export table
qiime tools export \
  --input-path /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100_200k.qza \
  --output-path /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100_200k

#and then convert to tsv
biom convert \
  -i /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100_200k/feature-table.biom \
  -o /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100_200k.biom \
  --to-tsv

  #convert to tsv
biom convert \
  -i /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100_200k.biom \
  -o /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100_200k.tsv \
  --to-tsv

  #export 100 table

qiime tools export \
  --input-path /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100.qza \
  --output-path /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100

#and then convert to tsv
biom convert \
  -i /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100/feature-table.biom \
  -o /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_100.tsv \
  --to-tsv

#use ~/TOL/minich/GMTOL_taxonomy2024_N20all_f2.qza to filter original cancer_mam table to just Fusobacterium

qiime taxa filter-table \
  --i-table /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam.qza \
  --i-taxonomy ~/TOL/minich/GMTOL_taxonomy2024_N20all_f2.qza \
  --p-include "Fusobacterium" \
  --o-filtered-table /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_Fusobacterium.qza

#run core metrics on the table now

qiime diversity core-metrics-phylogenetic \
  --i-phylogeny ~/TOL/minich/GMTOLsong_rooted_tree2024f2.qza \
  --i-table /ddn_scratch/sdegregori/cancer_mam/GMTOLsong_tableNov2024_N20_f2all_grpSpecies_cancer_mam_Fusobacterium.qza \
  --p-sampling-depth 1000 \
  --m-metadata-file /ddn_scratch/sdegregori/cancer_mam/cancer_mam_metadata2.txt \
  --output-dir /ddn_scratch/sdegregori/cancer_mam/core-metrics-phylo-results-GMTOLsong_tableN20_Fusobacterium_1000